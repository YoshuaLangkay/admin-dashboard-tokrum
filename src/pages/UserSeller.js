			...
			<div className="box-table-pengguna mt-3  ms-3  d-flex flex-column">
				...
				<div className="d-flex ms-3 ps-2 mt-3 ">
					<ul class="nav nav-pills" id="pills-tab" role="tablist">
						<li class="nav-item">
							<button
								class="nav-link  active btn-list-seller px-0"
								data-bs-toggle="pill"
						...
						<li class="nav-item ms-5">
							<button
								class="nav-link btn-list-seller px-0"
								data-bs-toggle="pill"
								data-bs-target="#pills-terverifikasi"
								type="button"
							>
								Terverifikasi (888)
							</button>
						...
						<li class="nav-item ms-5">
							<button
								class="nav-link btn-list-seller px-0"
								data-bs-toggle="pill"
								data-bs-target="#pills-menunggu"
								type="button"
							>
								Menunggu Verifikasi (777)
							</button>
						</li>
						<li class="nav-item ms-5">
							<button
				...
				<div className="tab-content " id="pills-tabContent">
					{/* SEMUA */}
					<div className="tab-pane fade show active " id="pills-semua" role="tabpanel" aria-labelledby="pills-semua">
						<div className="tbl-user-pengguna mx-auto mt-4 px-3 ">
							<Table hover>
								<thead className="table-head">
									<tr>
										...
										<th className=" th-tgl ">Tanggal Registrasi</th>
									</tr>
								</thead>
								<tbody>
									<tr>
										...
										<td>Ebel</td>
										<td>
											<span className="menunggu">Menunggu Verifikasi</span>
										</td>
										<td className="td-tgl">2 Januari 2022</td>
										<td className="text-center pe-3 link">
									...
									<tr>
										...
										<td>Ujang</td>
										<td>
											<span className="terverifikasi">Terverifikasi</span>
										</td>
										<td className="td-tgl">2 Januari 2022</td>
										<td className="text-center pe-3 link">
											<Link to="/seller/detail">
									...
									<tr>
										...
										<td>Herry</td>
										<td>
											<span className="ditolak">Ditolak</span>
										</td>
										<td className="td-tgl">2 Januari 2022</td>
										<td className="text-center pe-3 link">
											<Link to="/seller/detail">
					...
					{/* Terverifikasi */}
					<div className="tab-pane fade " id="pills-terverifikasi" role="tabpanel" aria-labelledby="pills-terverifikasi">
						<div className="tbl-user-pengguna mx-auto mt-4 px-3 ">
							<Table hover>
								<thead className="table-head">
									<tr>
					...
					{/* Menunggu Verifikasi */}
					<div className="tab-pane fade " id="pills-menunggu" role="tabpanel" aria-labelledby="pills-menunggu">
						<div className="tbl-user-pengguna mx-auto mt-4 px-3 ">
							<Table hover>
								<thead className="table-head">
									<tr>
					...
					{/* Ditolak */}
					<div className="tab-pane fade " id="pills-ditolak" role="tabpanel" aria-labelledby="pills-ditolak">
						<div className="tbl-user-pengguna mx-auto mt-4 px-3 ">
							<Table hover>
								<thead className="table-head">
									<tr>
								...
								<tbody>
									<tr>
										...
										<td>Ebel</td>
										<td>
										<span className="ditolak">Ditolak</span>										</td>
										<td className="td-tgl">2 Januari 2022</td>
										<td className="text-center pe-3 link">
											<Link to="/seller/detail">
												<Button className="ds-btn-table p-0 px-3">Selengkapnya</Button>
