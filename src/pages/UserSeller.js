	...
	return (
		<Container fluid className="pb-5">
			<div className="box-table-pengguna mt-3  ms-3  d-flex flex-column">
				...
				<div className="d-flex ms-4 ps-2 mt-3">
					<span className="label-verif  aktif pb-1">Semua (999)</span>
					<span className="label-verif  ms-5">Terverifikasi (888)</span>
					<span className="label-verif  ms-5">Menunggu Verifikasi (777)</span>
					<span className="label-verif  ms-5">Ditolak (55)</span>
				</div>
