...
import { FormControl, InputGroup, Button, Table, Form, Container, Pagination} from "react-bootstrap";
import BelumBayar from "../components/modalTransaksi/BelumBayar";
import Dikemas from "../components/modalTransaksi/Dikemas";
import Dikirim from "../components/modalTransaksi/Dikirim";
import Diterima from "../components/modalTransaksi/Diterima";
import PreOrder from "../components/modalTransaksi/PreOrder";

import "../css/transaksi.css";

function Transaksi() {
	const [showBelumDikirim, setBelumDikirim] = useState(false);
	const [showDikemas, setDikemas] = useState(false);
	const [showDikirim, setShowDikirim] = useState(false);
	const [showDiterima, setDiterima] = useState(false);
	const [showPreOrder, setPreOrder] = useState(false);
			...
			<div className="box-table-pengguna mt-3  ms-3  d-flex flex-column">
				...
				<div className="d-flex ms-3 ps-2 mt-3 ">
					<ul class="nav nav-pills" id="pills-tab" role="tablist">
						<li class="nav-item">
							<button
								class="nav-link  active btn-list-transaksi px-0"
								data-bs-toggle="pill"
								data-bs-target="#pills-belumBayar"
								type="button"
							>
								Belum Bayar (999)
							</button>
						...
						<li class="nav-item ms-5">
							<button
								class="nav-link btn-list-transaksi px-0"
								data-bs-toggle="pill"
								data-bs-target="#pills-dikemas"
								type="button"
							>
								Dikemas (888)
							</button>
						...
						<li class="nav-item ms-5">
							<button
								class="nav-link btn-list-transaksi px-0"
								data-bs-toggle="pill"
								data-bs-target="#pills-diterima"
								type="button"
							>
								Diterima & Beri Ulasan (55)
							</button>
						</li>
						<li class="nav-item ms-5">
							<button
				...
				<div className="tab-content " id="pills-tabContent">
					{/* Belum Bayar */}
					<div className="tab-pane fade show active " id="pills-semua" role="tabpanel" aria-labelledby="pills-belumBayar">
						<div className="tr-table mx-auto mt-4 px-3 ">
							<Table hover>
								<thead className="table-head">
									<tr>
										<th>Nomor Pesanan</th>
										<th className="px-4">Nama Pesanan</th>
								...
								<tbody className="">
									<tr>
										<td className="tr-invoice py-2">INV/20202020/XX/XV/554364534</td>
										<td className="py-3 px-4">Donal Trum</td>
										<td className="py-3">22 Juni 2022</td>
										<td className="py-3">Warung Mang Ujang</td>
										<td>
											<div className="tr-img d-flex">
												<img src="https://cf.shopee.co.id/file/adad3f8a9b306c1a4d2d7e896e085bfd" alt="img-produk" />
												<img src="https://cf.shopee.co.id/file/adad3f8a9b306c1a4d2d7e896e085bfd" alt="img-produk" />
												<img src="https://cf.shopee.co.id/file/adad3f8a9b306c1a4d2d7e896e085bfd" alt="img-produk" />
											</div>
										</td>
										<td className=" pe-3 py-3 link">
											<button className="tr-btn-modal" onClick={() => setBelumDikirim(true)}>
												Lihat Detail
											</button>{" "}
											<BelumBayar showBelumDikirim={showBelumDikirim} dikirim={() => setBelumDikirim(false)} />
										</td>
									</tr>
								</tbody>
							</Table>
					...
					{/* Dikemas */}
					<div className="tab-pane fade " id="pills-dikemas" role="tabpanel" aria-labelledby="pills-dikemas">
						<div className="tr-table mx-auto mt-4 px-3 ">
							<Table hover>
								<thead className="table-head">
									<tr>
								...
								<tbody className="">
									<tr>
										<td className="tr-invoice py-2">INV/20202020/XX/XV/554364534</td>
										<td className="py-3 px-4">Barak Obama</td>
										<td className="py-3">22 Juni 2022</td>
										<td className="py-3">Warung Mang Ujang</td>
										<td>
											<div className="tr-img d-flex">
										...
										<td className=" pe-3 py-3 link">
											<button className="tr-btn-modal" onClick={() => setDikemas(true)}>
												Lihat Detail
											</button>{" "}
											<Dikemas showDikemas={showDikemas} closeDikemas={() => setDikemas(false)} />
										</td>
									</tr>
								</tbody>
							</Table>
					...
					{/* Dikirim */}
					<div className="tab-pane fade " id="pills-dikirim" role="tabpanel" aria-labelledby="pills-dikirim">
						<div className="tr-table mx-auto mt-4 px-3 ">
							<Table hover>
								<thead className="table-head">
									<tr>
								...
								<tbody className="">
									<tr>
										<td className="tr-invoice py-2">INV/20202020/XX/XV/554364534</td>
										<td className="py-3 px-4">Dadang</td>
										<td className="py-3">22 Juni 2022</td>
										<td className="py-3">Warung Mang Ujang</td>
										<td>
											<div className="tr-img d-flex">
										...
										<td className=" pe-3 py-3 link">
											<button className="tr-btn-modal" onClick={() => setShowDikirim(true)}>
												Lihat Detail
											</button>
											<Dikirim showDikirim={showDikirim} closeDikirim={() => setShowDikirim(false)} />
										</td>
									</tr>
								</tbody>
							</Table>
					...
					{/* Diterima */}
					<div className="tab-pane fade " id="pills-diterima" role="tabpanel" aria-labelledby="pills-diterima">
						<div className="tr-table mx-auto mt-4 px-3 ">
							<Table hover>
								<thead className="table-head">
									<tr>
								...
								<tbody className="">
									<tr>
										...
										<td className=" pe-3 py-3 link">
											<button className="tr-btn-modal" onClick={() => setDiterima(true)}>
												Lihat Detail
											</button>{" "}
											<Diterima showDiterima={showDiterima} closeDiterima={() => setDiterima(false)} />
										</td>
									</tr>
								</tbody>
							</Table>
					...
					{/* PreOrder */}
					<div className="tab-pane fade " id="pills-preOrder" role="tabpanel" aria-labelledby="pills-preOrder">
						<div className="tr-table mx-auto mt-4 px-3 ">
							<Table hover>
								<thead className="table-head">
									<tr>
								...
								<tbody className="">
									<tr>
										<td className="tr-invoice py-2">INV/20202020/XX/XV/554364534</td>
										<td className="py-3 px-4">Bush</td>
										<td className="py-3">22 Juni 2022</td>
										<td className="py-3">Warung Mang Ujang</td>
										<td>
											<div className="tr-img d-flex">
										...
										<td className=" pe-3 py-3 link">
											<button className="tr-btn-modal" onClick={() => setPreOrder(true)}>
												Lihat Detail
											</button>{" "}
											<PreOrder showPreOrder={showPreOrder} closePreOrder={() => setPreOrder(false)} />
										</td>
									</tr>
								</tbody>
							</Table>
