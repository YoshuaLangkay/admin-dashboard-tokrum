...
function BelumBayar(props) {
	...
	return (
		<Modal show={props.showBelumDikirim} onHide={props.dikirim}>
			<div className="modalBayar ">
				<Modal.Header closeButton className="tr-modal-header">
					<Modal.Title className="ms-3 mt-3" style={{fontSize:"36px"}}>Detail Transaksi</Modal.Title>
				</Modal.Header>
				<Modal.Body>
							...
							<Col className="d-flex flex-column">
								...
								<Form.Group className="mb-3">
									...
									<div className="tr-box-status-modal d-flex align-items-center">
										<span className="tr-modal-dikirim px-3 py-1">Belum Bayar</span>
									</div>
								</Form.Group>
								<Form.Group className="mb-3">
