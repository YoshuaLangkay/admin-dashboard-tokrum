									...
									<section>
										...
										<div className="tabsss d-flex">
											<div className="steps1 d-flex">
												<div className="step-1">
													<div className="container">
														<h5
															className="kotak-nomor rounded pt-1 text-center pt-2 text-light shadow"
															style={{ width: "40px", height: "40px", backgroundColor: "#5979C0" }}
														>
															1
														</h5>
										...
										<div className="form-row d-flex">
											<div className="form-group  ">
												<label className="label-jeniskelamin form-check-label" for="flexRadioDefault1">
													Jenis Kelamin
												</label>
												<sup className="required" style={{ color: "red" }}>
													*
										...
										<div class="col-12 mt-4 d-flex justify-content-end pe-5">
											<button
												...
												style={{ width: "150px", height: "44px", backgroundColor: "#253863" }}
												type="submit"
											>
												Selanjutnya
											</button>
										...
										<div className="tabsss d-flex">
											<div className="steps1 d-flex">
												<div className="step-1">
													<div className="container">
														<h5
															className="kotak-nomor rounded pt-1 ps-3 text-light shadow"
															style={{ width: "40px", height: "40px", backgroundColor: "#5979C0" }}
														>
															<img className="ceklis" src={ceklis} alt="ceklis"></img>
														</h5>
														<h5 className="txt-on text-center">Identitas Pemilik</h5>
													</div>
												</div>
										...
										<div className="tabsss d-flex">
											<div className="steps1 d-flex">
												...
												<div className="steps2">
													<div className="container">
														<h5
															className=" kotak-nomor rounded  pt-1 ps-3 shadow"
															style={{
																width: "40px",
																height: "40px",
																backgroundColor: "#5979C0",
                      ...
                      <input style={{ backgroundColor: "#F0F4FA"}} type="text" class="form-control" id="contoh2" placeholder="Nama Belakang Anda" value={namaBelakang} onChange={changeNamaBelakang} required /> */}
										...
										<div class="col-12 mt-4 d-flex justify-content-end pe-5">
											...
											<button
												...
												style={{ width: "100px", height: "44px", backgroundColor: "white", borderColor: "red" }}
												type="submit"
											>
												Tolak
											</button>
								...
								{formStep === 6 && (
									<section>
										<div className="tabsss ms-4">
											<h1 className="title-tolak" style={{ color: "#3E4094" }}>
											...
											<div className="kotak-warning d-flex">
												...
												<p className="anda-menolak" style={{ marginTop: "-120px", marginLeft: "10px" }}>
											...
											<p
												...
												style={{ marginTop: "-115px", width: "700px", marginLeft: "70px" }}
											>
												Untuk kenyamanan calon Seller, anda diharuskan mengisi keterangan penolakan verifikasi
												dengan memberikan alasan secara jelas alasan penolakan{" "}
											</p>

											<h3 className="title" style={{ marginTop: "30px", marginLeft: "5px" }}>
												keterangan
											</h3>

											<p
												className="alasan"
												style={{ marginTop: "10px", width: "700px", marginLeft: "5px", color: "#646464" }}
											>
												Alasan Penolakan
											</p>
											<Form.Group
