                  ...
                  <div className="tabsss d-flex">
                    ...
                    <div className="form-row d-flex">
                      <div className="form-group  ">
                        <label className="label-jeniskelamin form-check-label" for="flexRadioDefault1">Jenis Kelamin</label>
                        <sup className="required" style={{ color: "red" }}>*</sup>
                        <Form.Select style={{ backgroundColor: "#F0F4FA", color:'#909090'}} className="jenisKelamin col-md-5" aria-label="Default select example">
                      ...
                      <div className="ktp form-group col-md-5" >
                        ...
                        <sup className="required" style={{ color: "red" }}>*</sup>
                        <input style={{ backgroundColor: "#F0F4FA"}} type="file" className="ktp-form form-control" id="contoh5" placeholder="Masukan No.KTP" value={noKtp} onChange={changeNoKtp} required />
                      </div>
                    </div>
                    ...
                    <div class="form-row d-flex justify-content-center">
                      ...
                      <div class="form-group col-md-5 ">
                        ...
                        <sup className="required" style={{ color: "red" }}>*</sup>
                        <input style={{ backgroundColor: "#F0F4FA", color:'#909090'}} className="bg-form" type="date" value={namaDepan} class="form-control" id="validationDefault01" onfocus="(this.type='date')" onChange={changeNamaDepan} required />
                      </div>
                      <div class="form-group col-md-5 ">
                    ...
                    <div class="form-row d-flex justify-content-center">
                      ...
                      <div class="form-group col-md-5 ">
                        ...
                        <sup className="required" style={{ color: "red" }}>*</sup>
                        <input style={{ backgroundColor: "#F0F4FA"}} className="bg-form" type="text" value={namaDepan} class="form-control" id="validationDefault01" placeholder="Masukan Alamat Lengkap" onChange={changeNamaDepan} required />
                      </div>
                      <div class="form-group col-md-5 ">
                    ...
                    <div class="form-row d-flex justify-content-center">
                      ...
                      <div class="form-group col-md-5 ">
                        ...
                        <sup className="required" style={{ color: "red" }}>*</sup>
                        <input style={{ backgroundColor: "#F0F4FA"}} className="bg-form" type="text" value={namaDepan} class="form-control" id="validationDefault01" placeholder="Kecamatan" onChange={changeNamaDepan} required />
                      </div>
                      <div class="form-group col-md-5 ">
                        <label for="contoh2">Kelurahan</label>
                        <sup className="required" style={{ color: "red" }}>*</sup>
                        <input style={{ backgroundColor: "#F0F4FA"}} type="text" class="form-control" id="contoh2" placeholder="Kelurahan" value={namaBelakang} onChange={changeNamaBelakang} required />
                      </div>
                    ...
                    <div class="form-row d-flex justify-content-center">
                      ...
                      <div class="form-group col-md-5 ">
                        ...
                        <sup className="required" style={{ color: "red" }}>*</sup>
                        <input style={{ backgroundColor: "#F0F4FA"}} className="bg-form" type="text" value={namaDepan} class="form-control" id="validationDefault01" placeholder="Provinsi" onChange={changeNamaDepan} required />
                      </div>
                      <div class="form-group col-md-5 ">
                        <label for="contoh2">Kode Pos</label>
                        <sup className="required" style={{ color: "red" }}>*</sup>
                        <input style={{ backgroundColor: "#F0F4FA"}} type="text" class="form-control" id="contoh2" placeholder="Kode Pos" value={namaBelakang} onChange={changeNamaBelakang} required />
                      </div>

                    </div>                  
                    
                    <div class="col-12 mt-4 d-flex justify-content-end pe-5">
                      <button onClick={completeFormStep0} class="btn text-light" style={{ width: "150px",height:"44px", backgroundColor: "#253863" }} type="submit">Selanjutnya</button>
                    </div>
                  </section>
                )}
...
<h1 className="judulVerif">Verifikasi Seller</h1>
                    ...
                    <div class="form-row d-flex justify-content-center">
                      ...
                      <label for="contoh2">Foto Tempat Usaha</label>
                        <sup className="required" style={{ color: "red" }}>*</sup>
                        <input style={{ backgroundColor: "#F0F4FA"}} type="file" class="form-control" id="contoh2" placeholder="Nama Belakang Anda" value={namaBelakang} onChange={changeNamaBelakang} required />
                      </div>
                      <div class="form-group col-md-5 ">
                        <label for="contoh2">Kota / Kabupaten</label>
                        <sup className="required" style={{ color: "red" }}>*</sup>
                    ...
                    <h3 className="title" style={{marginTop:'20px'}}>Sosial Media</h3>
                    ...
                    <div class="form-row d-flex justify-content-center">
                      ...
                      <label for="contoh2">Website</label>
                        <sup className="required" style={{ color: "red" }}>*</sup>
                        <input style={{ backgroundColor: "#F0F4FA"}} type="text" class="form-control" id="contoh2" placeholder="Masukan Website Anda" value={namaBelakang} onChange={changeNamaBelakang} required />
                      </div>
                      <div class="form-group col-md-5 ">
                        <label for="contoh2">Facebook</label>
                        <sup className="required" style={{ color: "red" }}>*</sup>
                        <input style={{ backgroundColor: "#F0F4FA"}} type="text" class="form-control" id="contoh2" placeholder="Masukan Facebook Anda" value={namaBelakang} onChange={changeNamaBelakang} required />
                      </div>
                    ...
                    <div class="form-row d-flex justify-content-center">
                      ...
                      <label for="contoh2">Instagram</label>
                        <sup className="required" style={{ color: "red" }}>*</sup>
                        <input style={{ backgroundColor: "#F0F4FA"}} type="text" class="form-control" id="contoh2" placeholder="Masukan Instagram Anda" value={namaBelakang} onChange={changeNamaBelakang} required />
                      </div>
                      <div class="form-group col-md-5 ">
                        <label for="contoh2">Twitter</label>
                        <sup className="required" style={{ color: "red" }}>*</sup>
                        <input style={{ backgroundColor: "#F0F4FA"}} type="text" class="form-control" id="contoh2" placeholder="Masukan Twitter Anda" value={namaBelakang} onChange={changeNamaBelakang} required />
                      </div>
                    ...
                    <div class="form-row d-flex justify-content-center">
                      ...
                      <label for="contoh2">Tiktok</label>
                        <sup className="required" style={{ color: "red" }}>*</sup>
                        <input style={{ backgroundColor: "#F0F4FA"}} type="text" class="form-control" id="contoh2" placeholder="Masukan Tiktok Anda" value={namaBelakang} onChange={changeNamaBelakang} required />
                      </div>
                      <div class="form-group col-md-5 ">
                        {/* <label for="contoh2">Facebook</label>
                        <sup className="required" style={{ color: "red" }}>*</sup>
            ...
            <h1 className="judulVerif">Verifikasi Seller</h1>
                    ...
                    <div class="form-row d-flex justify-content-center" style={{marginTop:'50px'}}>

                      <div class="form-group col-md-5 ">
                        <label for="contoh1">Nama Bank</label>
                        <sup className="required" style={{ color: "red" }}>*</sup>
                        <input style={{ backgroundColor: "#F0F4FA"}} className="bg-form" type="text" value={namaDepan} class="form-control" id="validationDefault01" placeholder="Bank Mandiri" onChange={changeNamaDepan} required />
                      </div>
                      <div class="form-group col-md-5 ">
                        <label for="contoh2">Nama Pemilik Rekening Bank</label>
                        <sup className="required" style={{ color: "red" }}>*</sup>
                        <input style={{ backgroundColor: "#F0F4FA"}} type="text" class="form-control" id="contoh2" placeholder="Ramli Ramadan" value={namaBelakang} onChange={changeNamaBelakang} required />
                      </div>
                    </div>

                  <div class="form-row d-flex justify-content-center" style={{marginTop:'10px'}}>

                    <div class="form-group col-md-5 " >
                      <label for="contoh1">Nomor Rekening Bank</label>
                      <sup className="required" style={{ color: "red" }}>*</sup>
                      <input style={{ backgroundColor: "#F0F4FA"}} className="bg-form" type="number" value={namaDepan} class="form-control" id="validationDefault01" placeholder="77372912810" onChange={changeNamaDepan} required />
                    </div>
                    <div class="form-group col-md-5 ">
                      {/* <label for="contoh2">Nama Belakang</label>
                      <sup className="required" style={{ color: "red" }}>*</sup>
                 ...
                 {formStep === 4 && (
                  ...
                  <div class="form-row d-flex justify-content-center" style={{marginTop:'10px'}}>
                    ...
                    <div class="form-group col-md-5 " >
                      ...
                      <sup className="required" style={{ color: "red" }}>*</sup>
                      <input style={{ backgroundColor: "#F0F4FA"}} className="bg-form" type="file" value={namaDepan} class="form-control" id="validationDefault01" placeholder="Nama Lengkap Anda" onChange={changeNamaDepan} required />
                    </div>
                    <div class="form-group col-md-5 ">
                      {/* <label for="contoh2">Nama Belakang</label>
                      <sup className="required" style={{ color: "red" }}>*</sup>
                  ...
                  <img className="icon-garis" src={blueLine} alt="garis"/>
                    ...
                    <div class="form-row d-flex justify-content-center" style={{marginTop:'50px'}}>
                      ...
                      <div class="form-group col-md-5 ">
                        ...
                        <sup className="required" style={{ color: "red" }}>*</sup>
                        <input style={{ backgroundColor: "#F0F4FA"}} className="bg-form" type="text" value={namaDepan} class="form-control" id="validationDefault01" placeholder="YumaJu" onChange={changeNamaDepan}  />
                      </div>
                      <div class="form-group col-md-5 ">
                        <label for="contoh2">Nomor Sertifikat Halal</label>
                        <sup className="required" style={{ color: "red" }}>*</sup>
                        <input style={{ backgroundColor: "#F0F4FA"}} type="text" class="form-control" id="contoh2" placeholder="Ramli Ramadan" value={namaBelakang} onChange={changeNamaBelakang}  />
                      </div>
                    </div>
                  ...
                  <div class="form-row d-flex justify-content-center" style={{marginTop:'10px'}}>
                    ...
                    <div class="form-group col-md-5 " >
                      ...
                      <sup className="required" style={{ color: "red" }}>*</sup>
                      <input style={{ backgroundColor: "#F0F4FA"}} className="bg-form" type="file" value={namaDepan} class="form-control" id="validationDefault01" placeholder="77372912810" onChange={changeNamaDepan}  />
                    </div>
                    <div class="form-group col-md-5 ">
                      {/* <label for="contoh2">Nama Belakang</label>
                      <sup className="required" style={{ color: "red" }}>*</sup>
                  ...
                  <p className='alasan' style={{marginTop:'10px',width:'700px', marginLeft:'5px', color:'#646464'}}>Alasan Penolakan</p>
                  <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1" style={{backgroundColor:'#F5F8FA', width:'95%'}}>
                    <Form.Control as="textarea" rows={3}  style={{backgroundColor:'#F5F8FA'}} placeholder='Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. ' />
                  </Form.Group>
                  </div>
