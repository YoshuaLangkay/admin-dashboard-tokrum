							...
							<Nav.Item className="activebtn">
								<Nav.Link href="#" className="labelLink">
									<div className="d-flex align-items-center mt-1">
										...
										<span className="labelIcon mx-1 px-1 px-1 ">
											Dasboard
										</span>
									</div>
								</Nav.Link>
							...
							<Nav.Item className="activebtn mt-2  ">
								...
								>
									<div className="d-flex align-items-center  mt-1">
										...
										<span className="labelIcon mx-1 px-1">
											Produk
										</span>
									</div>
								</Nav.Link>
								...
								>
									<div className="d-flex align-items-center  mt-1">
										...
										>
											<g fill="#B6BDCB ">
												<path
													d="m12.5 4.752-4.408 5.29a1.042 1.042 0 0 1-1.6-1.334l5.208-6.25a1.04 1.04 0 0 1 1.6 0l5.209 6.25a1.042 1.042 0 1 1-1.6 1.334L12.5 4.752Z"
													opacity=".3"
												/>
												<path
													fill-rule="evenodd"
													d="M5.158 9.375a1 1 0 0 0-.92 1.392l3.318 7.78a3 3 0 0 0 2.76 1.823h4.368a3 3 0 0 0 2.76-1.823l3.317-7.78a1 1 0 0 0-.92-1.392H5.158Zm9.425 6.25a2.083 2.083 0 1 1-4.166 0 2.083 2.083 0 0 1 4.166 0Z"
													clip-rule="evenodd"
												/>
											</g>
										</svg>
