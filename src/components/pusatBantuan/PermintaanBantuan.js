		...
		return (
			<div className="infoBuyer">
				...
				<div className="p-3 mt-2 border-bottom list-info-user">
					...
					<div className="row py-2">
						<div className="col-7 labelFillInfo">Nomor Akun</div>
				...
				<div className="px-2 border-bottom detail-bantuan">
					...
					<span className="labelHintBantuan ">Saya memesan barang dari Toko AAA dari bulan Januari dan sekarang Bulan Maret belum dikirim barangnya</span>
				</div>
				<div className="box-btn-bantuan d-flex align-items-end ">
					...
					<button className="btn-tutup-bantuan w-50 py-2" onClick={() => setShowBantuan(false)}>Tutup</button>
					</div>
				</div>
			</div>
		);
			...
			<div className="container-PusatBantuan mx-auto mt-4 px-3 d-flex justify-content-between">
				<div className="boxListPusatBantuan ms-1 ">
					{tableBantuan.map((el, i) => {
						return (
							<div className="listBantuan d-flex flex-column py-2 ps-3 mb-3" onClick={() => setShowBantuan(true)}>
				...
				<div className="isiBantuan  me-2 ">{showBantuan ? <>{isiBantuan()} </> : null}</div>
			</div>
		</>
	);
}
